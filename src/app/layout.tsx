...
import "./globals.css"; 
// FIX: Import both apiPlugin and storyblokBridge
import { storyblokInit, apiPlugin, storyblokBridge } from "@storyblok/react"; 
...
storyblokInit({
  ...
  // CRITICAL FIX: Add both plugins for full functionality
  use: [apiPlugin, storyblokBridge], 
  components, 
});
