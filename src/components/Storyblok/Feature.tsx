 ...
 * It's a common building block for sections or individual content items.
 */
const Feature: React.FC<FeatureProps> = ({ blok }) => {
  return (
    // storyblokEditable is crucial for the Storyblok Visual Editor to highlight and edit this component
